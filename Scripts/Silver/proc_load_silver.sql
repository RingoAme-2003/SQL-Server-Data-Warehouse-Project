...
Script Purpose :
    ...
    - Truncates the tables in the 'silver' schema before loading data.
    - Uses the 'INSERT' command to load Transformed and Cleansed from Bronze into Silver Tables.
...
-- ERP Source System Files
	...
	-- Table 3 : erp_px_cat_g1v2
		...
		PRINT '==================================================';
		PRINT 'TASK COMPLETED SILVER LAYER IS LOADED';
